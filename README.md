<p align="center">
  ...
  <b><big>Current stable release: <a href="https://github.com/nutjob-laboratories/merk/releases/tag/0.051.050">MERK 0.051.050</a></big></b><br>
  <b>Current development version: 0.051.053</b><br><br>
...
| Current Release |  -  | [MERK 0.051.050 Release](https://github.com/nutjob-laboratories/merk/releases/tag/0.051.050)  |
| Zip Archive|  Cross-platform  | [Download MERK 0.051.053 (12.40 MB)](https://www.dropbox.com/scl/fi/pf9p7ltb3uufm5akjz7l0/merk-latest.zip?rlkey=3caodopybbcxr4p9grxygxzym&st=01zsuura&dl=1)  |
| Zip Archive|  Windows EXE | [Download MERK 0.051.053 (49.29 MB)](https://www.dropbox.com/scl/fi/4w9ufyknzac24o06710bi/merk-windows-latest.zip?rlkey=zmir67l3klg8mw0omxayzmssc&st=vb69tsdi&dl=1)|
|   Windows Installer|  Windows Setup | [Download MERK 0.051.053 (46.40 MB)](https://www.dropbox.com/scl/fi/0u1vcg5xuntzs2b16e01b/merk_setup.zip?rlkey=8avj1gyed3txz1nfj9ev41mmh&st=zlve4c1o&dl=1)|

# Summary
  
**MERK** is a graphical [open source](https://www.gnu.org/licenses/gpl-3.0.en.html) [Internet relay chat](https://en.wikipedia.org/wiki/Internet_Relay_Chat) client. The current development version is **0.051.053**. It uses a [multiple-document interface](https://en.wikipedia.org/wiki/Multiple-document_interface), much like the popular Windows IRC client [mIRC](https://www.mirc.com/).  **MERK** is written in Python 3, using the [PyQt5](https://pypi.org/project/PyQt5/) and [Twisted](https://twistedmatrix.com/trac/) libraries, and runs on both Windows and Linux. **MERK** can load plugins, written in Python, just like **MERK**, which can be edited and created directly in the application. **MERK** is updated frequently with new features and bugfixes.

**MERK** is still in development, but it works, and can be used for most IRC activities. [The current stable release of **MERK** is version 0.051.050](https://github.com/nutjob-laboratories/merk/releases/tag/0.051.050). **MERK** has a user guide, which can be [viewed here](./MERK_User_Guide.pdf).
...
**MERK** has a version built with [PyInstaller](https://www.pyinstaller.org/) which you can run without having to install Python or any of the requirements. [You can download the current stable release (0.051.050) here](https://github.com/nutjob-laboratories/merk/releases/tag/0.051.050). For more information on **MERK** and how it works, [check out the user guide](./MERK_User_Guide.pdf).
...
- Very configurable, without having to manually edit a configuration file
    ...
    - Over 290 different settings can be changed, allowing you to customize **MERK** to look and function _exactly_ the way you want it to look and function.
...
<p><small><i>Screenshots may not reflect the current release (0.051.050), and may reflect the current development version (0.051.053). More screenshots are in the <a href="./MERK_User_Guide.pdf">MERK User Guide</a>.</i></small></p>
...
<center><a href="./graphics/screenshot_big.png"><img src="./graphics/screenshot1.png"></a></center></br>
 ...
 <center><a href="./graphics/settings.png"><img src="./graphics/settings_small.png"></a></center></br>
  <center><i><small>The first "page" of the settings dialog. MERK features over 290 settings that can be tweaked until MERK looks and works exactly like you want it to. All settings (except for "dark mode") are applied instantly.</small></i></center>
  </p>
...
| `/window [COMMAND] [X] [Y]`     | Manipulates the main application window. Valid commands are `move`, `resize`, `maximize`, `minimize`, `restore`, `readme`, `settings`, `logs`, `hotkey`,  `ignore`, `plugin`, `restart`, `cascade`, `tile`, `next`, and `previous`. Call with no arguments to see main window information and a list of subwindows                                                 |
