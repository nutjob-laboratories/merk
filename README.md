<p align="center">
  ...
  <b><big>Current stable release: <a href="https://github.com/nutjob-laboratories/merk/releases/tag/0.050.270">MERK 0.050.270</a></big></b><br>
  <b>Current development version: 0.050.288</b><br><br>
...
| Current Release |  -  | [MERK 0.050.270 Release](https://github.com/nutjob-laboratories/merk/releases/tag/0.050.270)  |
| Zip Archive|  Cross-platform  | [Download MERK 0.050.288 (11.85 MB)](https://www.dropbox.com/scl/fi/pf9p7ltb3uufm5akjz7l0/merk-latest.zip?rlkey=3caodopybbcxr4p9grxygxzym&st=01zsuura&dl=1)  |
| Zip Archive|  Windows | [Download MERK 0.050.288 (48.66 MB)](https://www.dropbox.com/scl/fi/4w9ufyknzac24o06710bi/merk-windows-latest.zip?rlkey=zmir67l3klg8mw0omxayzmssc&st=vb69tsdi&dl=1)|
|   Windows Installer|  Windows | [Download MERK 0.050.288 (45.78 MB)](https://www.dropbox.com/scl/fi/0u1vcg5xuntzs2b16e01b/merk_setup.zip?rlkey=8avj1gyed3txz1nfj9ev41mmh&st=zlve4c1o&dl=1)|

# Summary
  
**MERK** is a graphical [open source](https://www.gnu.org/licenses/gpl-3.0.en.html) [Internet relay chat](https://en.wikipedia.org/wiki/Internet_Relay_Chat) client. The current development version is **0.050.288**. It uses a [multiple-document interface](https://en.wikipedia.org/wiki/Multiple-document_interface), much like the popular Windows IRC client [mIRC](https://www.mirc.com/).  **MERK** is written in Python 3, using the [PyQt5](https://pypi.org/project/PyQt5/) and [Twisted](https://twistedmatrix.com/trac/) libraries, and runs on both Windows and Linux. **MERK** is updated frequently with new features and bugfixes.

**MERK** is still in development, but it works, and can be used for most IRC activities. [The current stable release of **MERK** is version 0.050.270](https://github.com/nutjob-laboratories/merk/releases/tag/0.050.270). **MERK** has a user guide, which can be [viewed here](./MERK_User_Guide.pdf).
...
- Very configurable, without having to manually edit a configuration file
    ...
    - Over 200 different settings can be changed, allowing you to customize **MERK** to look and function _exactly_ the way you want it to look and function.
...
<p><small><i>Screenshots may not reflect the current release (0.050.270), and may reflect the current development version (0.050.288). More screenshots are in the <a href="./MERK_User_Guide.pdf">MERK User Guide</a>.</i></small></p>
...
<center><a href="./graphics/screenshot_big.png"><img src="./graphics/screenshot1.png"></a></center></br>
 ...
 <center><a href="./graphics/settings.png"><img src="./graphics/settings_small.png"></a></center></br>
  <center><i><small>The first "page" of the settings dialog. MERK features over 200 settings that can be tweaked until MERK looks and works exactly like you want it to. All settings (except for "dark mode") are applied instantly.</small></i></center>
  </p>
...
| `/hide [WINDOW]`                                 | Hides a subwindow; only has access to windows associated with the current context                                                                                               |
...
| `/show [WINDOW]`               | Shows a subwindow, if hidden; only has access to windows associated with the current context                                         |
