<p align="center">
  ...
  <b><big>Current stable release: <a href="https://github.com/nutjob-laboratories/merk/releases/tag/0.043.020">MERK 0.043.020</a></big></b><br>
...
| :----:    | :----:    | :----:    |
| Current Release |  -  | [MERK 0.043.020 Release](https://github.com/nutjob-laboratories/merk/releases/tag/0.043.020)  |
...
**MERK** is still in development, but it works, and can be used for most IRC activities. [The current stable release of **MERK** is version 0.043.020](https://github.com/nutjob-laboratories/merk/releases/tag/0.043.020).
...
**MERK** has a version built with [PyInstaller](https://www.pyinstaller.org/) which you can run without having to install Python or any of the requirements. [You can download the current stable release here](https://github.com/nutjob-laboratories/merk/releases/tag/0.043.020).
...
<p><small><i>Screenshots may not reflect the current release (0.043.020), and may reflect the current development version (0.043.030).</i></small></p>
