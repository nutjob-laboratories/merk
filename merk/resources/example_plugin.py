...
#
# Comments in this file are unneccesary, and can be
# removed if desired. This file pre-defines all
# events that MERK plugins respond to, and includes
# documentation for methods built-in to the
# Plugin class for interactions with the client.
#
# |-------------------------------|
# | BEGIN PLUGIN BUILT-IN METHODS |
# |-------------------------------|
#
# The following methods are built into every MERK plugin.
...
class ExamplePlugin(Plugin):
    ...
    # |-------------------------|
    # | BEGIN PLUGIN ATTRIBUTES |
    # |-------------------------|

    # These attributes should be edited by the author
    # of the plugin. These values are used by MERK to
    # differentiate and display information about plugins
