...
DARK_SPELLCHECK_ICON = ":/icon-dark_spellcheck.png"
DARK_MENU_ICON = ":/icon-dark_menu.png"
DARK_WINDOW_ICON = ":/icon-dark_window.png"
DARK_SYSTRAY_ICON = ":/icon-dark_tray.png"
