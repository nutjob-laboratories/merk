...
class Dialog(QDialog):
	...
	@staticmethod
	def get_message_information(msg=config.DEFAULT_QUIT_MESSAGE,parent=None):
	...
	def __init__(self,msg=config.DEFAULT_QUIT_MESSAGE,parent=None):
		super(Dialog,self).__init__(parent)

		self.parent = parent
		self.msg = msg

		self.setWindowTitle("Set Quit/Part Message")
		self.setWindowIcon(QIcon(DISCONNECT_ICON))
