		...
		if len(servers)>0:
			for window in servers:
				...
				if c.client.kwargs["ssl"]:
					...
					sec = "No"
				runmenuLabel = MenuLabel( menuHtml(RUN_MENU_ICON,"Run on "+cname+"&nbsp;","<b>Host:</b> "+c.name+"<br><b>Network:</b> "+network+"<br><b>Nickname:</b> "+c.client.nickname+"<br><b>Encrypted:</b> "+sec,25) )
