				...
				for w in windows:
					...
					if no_hostname:
						...
						if disco_msg==None:
							...
							if config.ENABLE_EMOJI_SHORTCODES: disco_msg = emojize(disco_msg,config.EMOJI_LANGUAGE)
							if config.ENABLE_ASCIIMOJI_SHORTCODES: disco_msg = asciimojize(disco_msg)
							msg = disco_msg
